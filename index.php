  ...
  <body onload="ajax('body')">
      ...
      <div class="header"> 
            <form method="post" action="firstPage.php">
              <button id="home"><span id="home1" class="glyphicon glyphicon-home"></span></button>
            </form>
      </div>
             
      <div class="section">
            
            <div class="previous" onclick="ajax('pre')">
              <input type="submit" name="pre" value="<" style="background-color: black;border:none"></input>
            </div>
            <div id="d">
            ...
            <div id="ajax"></div>
              ...
              <div class="next" onclick="ajax('next')">
                <input type="submit" name="next" value=">" style="background-color: black;border:none"></input>
              </div>
            </div>
